...
const OnboardingGriffin: NextPage = () => {
  return (
    <>
      <Head>
        <title>Onboarding The Griffin Auto Group - SalesAssist</title>
        <link rel="icon" href="/favicon.png" />
      </Head>
      <Nav />
      <Header title="SalesAssist Onboarding" subtitle="The Griffin Auto Group" />
      <DoubleColumn
        content={
          <>
            <h1>
            ...
            <h4>
              ...
              Click on the floating SalesAssist button and login with your same eLead username and this temporary password: griffin2022
            </h4>
          </>
        }
        media={
