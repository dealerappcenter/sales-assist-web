      ...
      <section id='policy'>
        <Section className="container mx-auto py-12 flex flex-col gap-6 text-gray-primary">
          ...
          <div className="flex flex-col gap-6">
            ...
            {PolicyData?.data.payment.description.map((paragraph, i) => <p className="" key={paragraph}  style="font-size:17px;">{paragraph} {i === lastPayment &&
          ...
          <div className="flex flex-col gap-6">
            ...
            {PolicyData?.data.contact.description.map((paragraph, i) => <p className="" style="font-size:17px;" key={paragraph}>{paragraph} {i === lastContact &&
