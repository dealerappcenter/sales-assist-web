...
export const TeamIcon: React.FC<TeamIconProps> = ({ src, title, name, link, code }) => {
  ...
  return (
    <div className='w-2/5 gap-4 md:w-1/3 lg:w-1/6 flex items-center justify-center flex-col mx-auto md:mx-0 mb-6 p-2 md:p-4'>
      <div className='relative h-20 w-20 rounded-full overflow-hidden flex items-center justify-center bg-white-normal'>
      ...
      <div className='flex items-center justify-center flex-col'>
        <div>
          <h3 className='font-medium text-sm lg:text-base inline mr-1'>{name}</h3>
