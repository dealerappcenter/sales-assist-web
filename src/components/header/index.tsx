      ...
      <Section className='lg:px-0'>
        <div className='flex justify-center flex-col gap-6'>
          <div className='flex flex-col pb-12'>
            <h1 className='text-4xl md:text-6xl lg:text-7xl lg:tracking-wide lg:leading-[5.375rem] lg:mb-1.5'>{ title }</h1>
            <div className='flex flex-row gap-2 md:gap-4 lg:tracking-wide lg:leading-[5.375rem]'>
              <h1 className='text-4xl md:text-6xl lg:text-7xl text-orange-normal font-normal'>{ subtitle }</h1>
            </div>
          </div>
        </div>
      </Section>
